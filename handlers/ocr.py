        ...
        if str(message.from_user.id) + '\n' in premium_users:
            if message.reply_to_message and message.reply_to_message.document:
                if message.reply_to_message.document.file_name.lower() == "images.zip":
                    ...
                    completion_message = "<code>Image processing complete!<code>"
                ...
                await message.reply_text("<b><i>Please reply to a message containing an <i><code>/ocr images.zip</code></b>")
        else:
            await message.reply_text(f'<b>⎚ Register with <code>/register</code></b>')
        ...
        while True:
            try:
                ...
                try:
                    ...
                    print(
                        f"<b>Error processing {imgname}: Filename format is incorrect. Please ensure the correct format is used.</b>")
                    return
